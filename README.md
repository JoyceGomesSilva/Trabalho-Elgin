...
1. Como baixar os arquivos pelo GitHub
Se você nunca usou o GitHub, siga este passo a passo:
- Abra o link do repositório no navegador.
- Clique no botão Code.
- Clique em Download ZIP.
- Vá até a pasta onde o ZIP foi salvo.
- Clique com o botão direito e escolha Extrair tudo.
Você agora terá uma pasta com todos os arquivos do projeto.

2. Como executar o programa
- Abra o projeto em qualquer IDE Java ou execute pelo terminal.
- O menu será exibido automaticamente.
- Antes de realizar qualquer impressão, escolha a opção de configurar a conexão.
- Depois abra a conexão.
- Selecione qualquer função do menu para executar as operações.
...
# Autores do Projeto: Joyce Gomes da Silva, Paulo Ricardo Monteiro Batista, Ana Luiza de Oliveira, Henrique Sousa Barbosa e Kauê Lino Borges
